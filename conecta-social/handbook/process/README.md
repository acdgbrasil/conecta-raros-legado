...
- [Servidor Bun Native](./architectures/bun_server_architecture.md): Guia para infraestrutura HTTP, roteamento e BFFs.

## Fluxo de Desenvolvimento

1.  **Design**: Criar/Atualizar a documentação no `handbook/domain_questions/` antes de codar.
2.  **TDD**: Escrever o teste unitário do UseCase (RED), quando aplicável.
3.  **Implementação**: Escrever o código para passar no teste (GREEN).
4.  **Refactor**: Melhorar, documentar e revisar impactos (BLUE).
