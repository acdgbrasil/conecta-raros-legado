...
```
If DISTINCT is specified with an order_by_clause, ORDER BY expressions can only reference
columns in the DISTINCT list. For example:
46
SQL Syntax
```
WITH vals (v) AS ( VALUES (1),(3),(4),(3),(2) )
...
one evaluation of the subquery. See also Section 9.24 for other expressions involving subqueries.
...
```
ing details of this function definition are not important here (see Chapter 36 for more information).
```
